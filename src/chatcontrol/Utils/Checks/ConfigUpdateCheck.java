...
public class ConfigUpdateCheck {
		...
		if (!latestVersion.equals(plVersion)) {
			try {
				if (plVersion.equals("4.1.5")) {
					...
					updateConfigTo449();
					updateConfigTo450();
				} else if (plVersion.equalsIgnoreCase("4.4.7")) {
					updateConfigTo448();
					updateConfigTo449();
					updateConfigTo450();
				} else if (plVersion.equalsIgnoreCase("4.4.8")) {
					updateConfigTo449();
					updateConfigTo450();
				} else if (plVersion.equalsIgnoreCase("4.4.9")) {
					updateConfigTo450();
	...
	private static void updateConfigTo441() {
		...
		ChatControl.Config.set("Commands.Block_Similar_Commands", true);
	...
	private static void updateConfigTo448() {
		ChatControl.Config.set("Chat_Formatter.Enabled", false);
		ChatControl.Config.set("Chat_Formatter.Message_Format", "%prefix%player:%suffix %message");
		ChatControl.Config.set("Chat_Formatter.Global_Message_Format", "%prefix%player%suffix &e%message");
	...
	private static void updateConfigTo449() {
		ChatControl.Config.set("Commands.Block_Similar_Commands", ChatControl.Config.getString("Commands.Block_Similar_Messages"));
		ChatControl.Config.set("Commands.Block_Similar_Messages", null);
	}
	
	private static void updateConfigTo450() {
		ChatControl.Config.set("Miscellaneous.RegEx_Timeout_Milis", 1500);
	}
